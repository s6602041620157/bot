...
def _mode_instruction(mode: str) -> str:
    ...
    if normalized == "fallback":
        return (
            "โหมด Fallback: ตอบจากข้อมูลที่มีใน CONTEXT อย่างระมัดระวัง\n"
            "ให้ตอบแบบธรรมชาติ เสมือนตอบคำถามปกติ\n"
            "หากข้อมูลไม่เพียงพอ ให้ระบุอย่างชัดเจน"
        )
    elif normalized == "partial":
        return (
            "โหมด Partial: มีข้อมูลบางส่วนที่เกี่ยวข้อง\n"  
            "ตอบเฉพาะในส่วนที่มีข้อมูลรองรับ และระบุว่าข้อมูลอาจไม่ครบถ้วน\n"
            "ให้คำแนะนำสำหรับการถามคำถามเพิ่มเติม"
        )
    return (
